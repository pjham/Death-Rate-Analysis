...
-   453 rows, each country had 3 rows for three different categories: Male, Female and Both Sexes
...
g1 <- g1+ theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+xlab("Developed Countries")+scale_colour_manual(labels = c("Both Sexes", "Female", "Male"), values = c("Red", "Green","Blue"))
...
g2 <- g2+ theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+xlab("Developing Countries")+scale_colour_manual(labels = c("Both Sexes", "Female", "Male"), values = c("Red", "Green","Blue"))
...
load("/Users/pj/Library/CloudStorage/OneDrive-IITKanpur/IITK sem 3/MTH208A/group-project-20/FinalData/Death rates/Final_data_3.Rdata")
  ...
  g1<-g1+scale_fill_discrete(labels = c("Both Sexes", "Female","Male"))
...
counts<-c("Egypt","Iraq","Jordan","Lebanon","Libya","Saudi Arabia","Sudan","Somalia")
  ...
  g2<-g2 + theme(plot.title= element_text(size=16, 
                 ...
                 axis.title = element_text(face="bold"),
                 axis.text = element_text(face= "bold"))
  g2<-g2+scale_fill_discrete(labels = c("Both Sexes", "Female","Male"))
  g2
...
g2<-g2+ theme(plot.title= element_text(size=16,
              ...
              legend.title = element_text(size=14,
                                          face="bold.italic"),
              axis.title = element_text(face="bold"),
              axis.text = element_text(face= "bold"),text = element_text(size=6))
g2
...
load("/Users/pj/Library/CloudStorage/OneDrive-IITKanpur/IITK sem 3/MTH208A/group-project-20/FinalData/Death rates/Final_data_3.Rdata")
  ...
  g+scale_fill_discrete(labels = c("Both Sexes", "Female","Male")) 
